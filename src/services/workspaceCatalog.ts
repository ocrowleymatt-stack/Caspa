...
export const WORKSPACE_TOOLS: WorkspaceTool[] = [
  ...
  { id: 'workshop', label: 'Workshop diagnosis', help: 'A short note on what is stuck on the page you can see. Notes appear on the paper above the page. The manuscript is not changed.', stages: ['Workshop'] },
  { id: 'swarm', label: 'Critic Swarm', help: 'Four specialists read this page through Atlas. Their notes appear on the paper above the page. The manuscript is not changed.', stages: ['Workshop', 'Revise'] },
