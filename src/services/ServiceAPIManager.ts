...
const JOBS_DIR = process.env.CASPA_JOBS_DIR || path.join(process.cwd(), 'data', 'service-jobs');
const RESULTS_DIR = process.env.CASPA_RESULTS_DIR || path.join(process.cwd(), 'data', 'service-results');
