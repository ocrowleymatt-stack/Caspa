...
echo "=== CASPA RUNTIME SMOKE (FULL) ==="
echo "Full authenticated workflow — expect several minutes of AI calls."
date -u
...
if [[ -f .env ]]; then
  echo "--- FULL: AUTHENTICATED WORKFLOW ---"
  python3 -u - <<'PY'
...
try:
    ...
    print("--- FULL: RESEARCH DEPTH PASS (AI) ---")
    ...
    print("--- FULL: MANUSCRIPT IMPROVE (AI) ---")
    ...
    print("--- FULL: CONTINUE WRITING (AI) ---")
    ...
    print("--- FULL: BIBLE GENERATION (AI) ---")
